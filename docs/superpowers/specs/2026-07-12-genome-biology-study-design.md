...
5. The final runner requires a clean Git commit, frozen config hash, protocol hash, environment hash, and unseen final manifest. It writes a one-use evaluation receipt.
