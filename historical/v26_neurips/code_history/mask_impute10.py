...
def main() -> None:
    ...
    parser.add_argument("output_dir", help="Output directory for mask_impute10_*_mse_table.tsv")
    ...
    parser.add_argument("--zero-iso-bio-weight-grid", type=str, default="0,1,2,4")
    ...
    _write_table(output_dir / "mask_impute10_raw_mse_table.tsv", best_raw)
    _write_table(output_dir / "mask_impute10_no_biozero_mse_table.tsv", best_no_bio)
    _write_table(output_dir / "mask_impute10_mse_table.tsv", best_final)

    tuning_path = output_dir / "mask_impute10_tuning.tsv"
    tuning_cols = [
        "config_id",
        "objective",
        "avg_mse_biozero",
    ...
    print(f"Wrote {output_dir / 'mask_impute10_raw_mse_table.tsv'}")
    print(f"Wrote {output_dir / 'mask_impute10_no_biozero_mse_table.tsv'}")
    print(f"Wrote {output_dir / 'mask_impute10_mse_table.tsv'}")
