...
with optional supervised biozero calibration/classification and post-threshold
calibration on observed zeros.
"""
...
def main() -> None:
    ...
    parser.add_argument("output_dir", help="Output directory for mask_impute8_*_mse_table.tsv")
    ...
    _write_table(output_dir / "mask_impute8_raw_mse_table.tsv", best_raw)
    _write_table(output_dir / "mask_impute8_no_biozero_mse_table.tsv", best_no_bio)
    _write_table(output_dir / "mask_impute8_mse_table.tsv", best_final)

    tuning_path = output_dir / "mask_impute8_tuning.tsv"
    tuning_cols = [
        "config_id",
        "objective",
        "avg_mse_biozero",
    ...
    print(f"Wrote {output_dir / 'mask_impute8_raw_mse_table.tsv'}")
    print(f"Wrote {output_dir / 'mask_impute8_no_biozero_mse_table.tsv'}")
    print(f"Wrote {output_dir / 'mask_impute8_mse_table.tsv'}")
