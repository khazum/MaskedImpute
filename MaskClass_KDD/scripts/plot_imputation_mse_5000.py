#!/usr/bin/env python3
"""
Generate KDD-ready bar plots for denoising accuracy on synthetic data (N=5,000).
...
def _load_tables(repo_root: Path) -> pd.DataFrame:
    files = {
        # Treat option3_labelcal_auto_structlight_centerrow as "MaskClass" in the paper.
        "MaskClass": repo_root
        / "results_imputation_py/option3_labelcal_auto_structlight_centerrow/cells_5000"
        / "option3_labelcal_auto_structlight_centerrow_mse_table.tsv",
        ...
        "ccImpute": repo_root / "results_imputation_r/ccimpute/cells_5000/ccimpute_mse_table.tsv",
        "Baseline": repo_root / "results_imputation_r/baseline/cells_5000/baseline_mse_table.tsv",
    }
