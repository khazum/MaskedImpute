...
\usepackage{dblfloatfix} % allow bottom placement of two-column floats
...
otherwise, \textbf{MaskClass} refers to the balanced configuration
(MaskClass$_{\mathrm{balanced}}$; $\gamma{=}1$). Table~\ref{tab:mse_5000}
